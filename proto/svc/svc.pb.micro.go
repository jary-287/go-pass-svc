...
type SvcService interface {
	...
	DeleteSvc(ctx context.Context, in *SvcInfo, opts ...client.CallOption) (*Response, error)
...
func (c *svcService) DeleteSvc(ctx context.Context, in *SvcInfo, opts ...client.CallOption) (*Response, error) {
...
type SvcHandler interface {
	...
	DeleteSvc(context.Context, *SvcInfo, *Response) error
...
func RegisterSvcHandler(s server.Server, hdlr SvcHandler, opts ...server.HandlerOption) error {
	type svc interface {
		...
		DeleteSvc(ctx context.Context, in *SvcInfo, out *Response) error
...
func (h *svcHandler) DeleteSvc(ctx context.Context, in *SvcInfo, out *Response) error {
